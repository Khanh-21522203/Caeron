...
/// Response to get next available session id command.
/// Layout:
///   [ 0] i64  correlation_id
///   [ 8] i32  next_session_id
///   [12] total length = 12
inline constexpr i32 NEXT_AVAILABLE_SESSION_ID_LENGTH = 12;

class NextAvailableSessionIdFlyweight {
public:
    ...
    explicit NextAvailableSessionIdFlyweight(concurrent::UnsafeBuffer& buffer, i32 offset = 0) noexcept
    ...
    [[nodiscard]] i32 next_session_id() const noexcept { return buffer_.get_i32(offset_ + 8); }
    void set_next_session_id(i32 value) noexcept { buffer_.put_i32(offset_ + 8, value); }
